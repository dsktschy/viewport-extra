      ...
      test.describe('comparison with minWidth and maxWidth, and computation of output initial-scale', () => {
        ...
        test.describe('case where unscaledComputing property in merged globalParameters object is false', () => {
          ...
          test.describe('case where initial scale before running setParameters is 1 or less', () => {
            test('width of viewport is used for comparison, and initialScale property merged from current partialMediaSpecificParametersList variable and first argument is applied to output initial-scale', async ({
              page,
              viewport
            }, { config: { projects } }) => {
              const minWidth =
          ...
          test.describe('case where initial scale before running setParameters is greater than 1', () => {
            test('width of window without scroll bars when scale is 1 is used for comparison, and initialScale property merged from current partialMediaSpecificParametersList variable and first argument is applied to output initial-scale', async ({
              page,
              viewport
            }, { config: { projects } }) => {
              const minWidth =
