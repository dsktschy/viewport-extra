...
for (const {
  ...
  },
  {
    ...
    moduleFlag: true,
    minified: false,
    outputSubDirectory: "extended/",
    assetSubDirectory: "extended/es/",
  },
  {
    immediate: false,
    extended: true,
    ...
    minified: false,
    outputSubDirectory: "extended/",
    assetSubDirectory: "extended/cjs/",
  },
  {
    immediate: false,
    extended: true,
    ...
    minified: false,
    outputSubDirectory: "extended/",
    assetSubDirectory: "extended/iife/",
  },
  {
    immediate: false,
    extended: true,
  ...
  },
  {
    ...
    moduleFlag: true,
    minified: false,
    outputSubDirectory: "extended/es5/",
    assetSubDirectory: "extended/es/es5/",
  },
  {
    immediate: false,
    extended: true,
    ...
    minified: false,
    outputSubDirectory: "extended/es5/",
    assetSubDirectory: "extended/cjs/es5/",
  },
  {
    immediate: false,
    extended: true,
    ...
    minified: false,
    outputSubDirectory: "extended/es5/",
    assetSubDirectory: "extended/iife/es5/",
  },
  {
    immediate: false,
    extended: true,
  ...
  },
  {
    ...
    moduleFlag: true,
    minified: false,
    outputSubDirectory: "immediate/extended/",
    assetSubDirectory: "immediate/extended/es/",
  },
  {
    immediate: true,
    extended: true,
    ...
    minified: false,
    outputSubDirectory: "immediate/extended/",
    assetSubDirectory: "immediate/extended/cjs/",
  },
  {
    immediate: true,
    extended: true,
    ...
    minified: false,
    outputSubDirectory: "immediate/extended/",
    assetSubDirectory: "immediate/extended/iife/",
  },
  {
    immediate: true,
    extended: true,
  ...
  },
  {
    ...
    moduleFlag: true,
    minified: false,
    outputSubDirectory: "immediate/extended/es5/",
    assetSubDirectory: "immediate/extended/es/es5/",
  },
  {
    immediate: true,
    extended: true,
    ...
    minified: false,
    outputSubDirectory: "immediate/extended/es5/",
    assetSubDirectory: "immediate/extended/cjs/es5/",
  },
  {
    immediate: true,
    extended: true,
    ...
    minified: false,
    outputSubDirectory: "immediate/extended/es5/",
    assetSubDirectory: "immediate/extended/iife/es5/",
  },
  {
    immediate: true,
    extended: true,
          ...
          await page.setContent(`
            ...
            <html lang="en">
              ...
              <body>
                ...
                `}'></script>
                <script src="/assets/scripts/${assetSubDirectory}call-apply.js" type="module" data-asset-script data-status="incomplete"></script>
              </body>
            </html>
          `);
  ...
  if (!immediate && typescriptTarget === "es2022" && format === "es") {
    if (extended) {
      // Following cases cannot be tested with Vitest
      test.describe("setParameters", () => {
