...
test.describe("activateAttributes", () => {
  ...
  test.describe("behavior according to attributes of viewport(-extra) meta elements", () => {
    test.describe("(data-extra-)content attribute", () => {
      ...
      test.describe("case where initial-scale before running activateAttributes is 1 or less", () => {
      ...
      test.describe("case where initial-scale before running activateAttributes is greater than 1", () => {
        test.describe("comparison with min-width", () => {
          test("window width without scroll bars when scale is 1 is used", async ({
            page,
            viewport,
    ...
    test.describe("data-(extra-)decimal-places attribute", () => {
      test.describe("case where value is finite", () => {
        test("removes digits less than specified value from calculated content attribute", async ({
          page,
          viewport,
        }, { config: { projects } }) => {
          const smViewportWidth =
          ...
          await page.setContent(`
            ...
            <html lang="en">
              <head>
                <meta charset="UTF-8" />
                <title>Document</title>
                <meta name="viewport" content="width=device-width,initial-scale=1" data-extra-content="min-width=${smViewportWidth}" data-decimal-places="6" />
              </head>
              <body>
                <script src="/assets/scripts/unit/call-activateAttributes.js" type="module"></script>
              </body>
      ...
      test.describe("case where value is infinite", () => {
        test("does not update decimal places of calculated content attribute", async ({
          page,
          viewport,
        }, { config: { projects } }) => {
          const smViewportWidth =
          ...
          await page.setContent(`
            ...
            <html lang="en">
              <head>
                <meta charset="UTF-8" />
                <title>Document</title>
                <meta name="viewport" content="width=device-width,initial-scale=1" data-extra-content="min-width=${smViewportWidth}" data-decimal-places="Infinity" />
              </head>
              <body>
                <script src="/assets/scripts/unit/call-activateAttributes.js" type="module"></script>
              </body>
  ...
  test.describe("determination of value to apply from multiple viewport(-extra) meta elements", () => {
    ...
    test.describe("data-(extra-)decimal-places attributes", () => {
      test.describe("case where media attributes are not set", () => {
        test("uses attribute that is set latest of all viewport and viewport-extra meta elements", async ({
          page,
          viewport,
        }, { config: { projects } }) => {
          const smViewportWidth =
          ...
          await page.setContent(`
            ...
            <html lang="en">
              <head>
                ...
                <meta name="viewport" content="width=device-width,initial-scale=1" data-extra-content="min-width=${smViewportWidth}" data-extra-decimal-places="4" />
                <meta name="viewport-extra" content="width=device-width,initial-scale=1,min-width=${smViewportWidth}" data-decimal-places="5" />
                <meta name="viewport" content="width=device-width,initial-scale=1" data-extra-content="min-width=${smViewportWidth}" data-extra-decimal-places="6" />
              </head>
              <body>
                <script src="/assets/scripts/unit/call-activateAttributes.js" type="module"></script>
              </body>
