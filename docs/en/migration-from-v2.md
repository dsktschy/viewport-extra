...
+   src="https://cdn.jsdelivr.net/npm/viewport-extra@3.0.0-rc.1"
  ...
  <!-- For environments that do not support ES2021 syntax and features in the Widely Available stage of the Web Platform Baseline as of the release of Viewport Extra v3.0.0-rc.1 -->
  <script
    async
-   src="https://cdn.jsdelivr.net/npm/viewport-extra@3.0.0-rc.1/dist/iife/viewport-extra.min.js"
