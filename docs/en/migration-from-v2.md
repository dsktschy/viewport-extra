...
- **Advanced Features:** Features that are usually unnecessary. As of v3.0.0, this includes the feature to specify decimal places.<!-- x-release-please-version -->
...
```html
<script async src="https://cdn.jsdelivr.net/npm/viewport-extra@3.0.0/dist/immediate/viewport-extra.min.js"></script>
```
...
```html
<script async src="https://cdn.jsdelivr.net/npm/viewport-extra@3.0.0/dist/viewport-extra.min.js"></script>
```
...
```html
<script async src="https://cdn.jsdelivr.net/npm/viewport-extra@3.0.0/dist/immediate/es5/viewport-extra.min.js"></script>
```
...
```html
<script async src="https://cdn.jsdelivr.net/npm/viewport-extra@3.0.0/dist/immediate/extended/viewport-extra.min.js"></script>
```
...
```html
<script async src="https://cdn.jsdelivr.net/npm/viewport-extra@3.0.0/dist/immediate/extended/es5/viewport-extra.min.js"></script>
```
...
<meta
  ...
  data-extra-content="min-width=412"
>
<script src="https://cdn.jsdelivr.net/npm/viewport-extra@3.0.0/dist/immediate/viewport-extra.min.js"></script>
