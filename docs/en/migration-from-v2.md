...
+   src="https://cdn.jsdelivr.net/npm/viewport-extra@2.5.0/dist/immediate/es5/viewport-extra.min.js"
  ...
  <script
    async
-   src="https://cdn.jsdelivr.net/npm/viewport-extra@2.5.0/dist/iife/viewport-extra.min.js"
+   src="https://cdn.jsdelivr.net/npm/viewport-extra@2.5.0/dist/immediate/extended/viewport-extra.min.js"
  ></script>

  <!-- If not using meta element parsing and immediate application and only using API calls -->
  <script
-   src="https://cdn.jsdelivr.net/npm/viewport-extra@2.5.0/dist/iife/viewport-extra.min.js"
+   src="https://cdn.jsdelivr.net/npm/viewport-extra@2.5.0/dist/viewport-extra.min.js"
  ></script>
  <script>
...
- **Advanced Features:** Features that are usually unnecessary. As of v2.5.0, this includes the feature to specify decimal places.<!-- x-release-please-version -->
...
```html
<script async src="https://cdn.jsdelivr.net/npm/viewport-extra@2.5.0/dist/viewport-extra.min.js"></script>
```
...
```html
<script async src="https://cdn.jsdelivr.net/npm/viewport-extra@2.5.0/dist/immediate/extended/viewport-extra.min.js"></script>
```
...
<meta
  ...
  data-extra-content="min-width=412"
>
<script src="https://cdn.jsdelivr.net/npm/viewport-extra@2.5.0/dist/immediate/viewport-extra.min.js"></script>
