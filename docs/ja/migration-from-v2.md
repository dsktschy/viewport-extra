...
+   src="https://cdn.jsdelivr.net/npm/viewport-extra@3.0.0-rc.1"
  ...
  <!-- ES2021 の構文、および Viewport Extra v3.0.0-rc.1 公開時点における Web Platform Baseline の Widely Available ステージにある機能をサポートしない環境で動作させる場合 -->
  <script
    async
-   src="https://cdn.jsdelivr.net/npm/viewport-extra@3.0.0-rc.1/dist/iife/viewport-extra.min.js"
...
- **高度な機能:** ほとんどの場合不要な機能です。v3.0.0-rc.1 時点では、小数点以下の桁数指定機能がこれに含まれます。<!-- x-release-please-version -->
