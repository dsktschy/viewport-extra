...
```html
<script
  src="https://cdn.jsdelivr.net/npm/viewport-extra@2.3.1/dist/iife/viewport-extra.min.js"
  async
></script>
```
...
```html
<meta name="viewport" content="width=device-width,initial-scale=1" />
<script src="https://cdn.jsdelivr.net/npm/viewport-extra@2.3.1/dist/iife/viewport-extra.min.js"></script>
<script>
